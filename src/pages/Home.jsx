...
export const Home = () => {
  ...
  return (
    <div className="w-full h-full lg:h-screen items-center px-7 lg:px-10 overflow-hidden grid grid-cols-3 gap-16 align-middle">
      <div className="col-span-6 xl:col-span-2 py-8 lg:py-24 mt-2 lg:mt-32 xl:mt-0 px-5">
        ...
        <p className="text-md lg:text-lg leading-6 xl:leading-8 mt-8 text-textColor font-syne">
      ...
      {/* <div className="relative rounded-lg bg-animation">
        <div className="rounded-lg z-50 relative p-1">
          <div className="hidden xl:block">
            <motion.img
              src="../assets/me.jpg"
              alt="about"
